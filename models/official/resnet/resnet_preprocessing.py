...
def preprocess_for_train(image_bytes, use_bfloat16, image_size=IMAGE_SIZE,augment_name=None, randaug_num_layers=None, randaug_magnitude=None):
...
def preprocess_for_trainaugment(image_bytes, use_bfloat16, image_size=IMAGE_SIZE,augment_name=None, randaug_num_layers=None, randaug_magnitude=None):
    """Preprocesses the given image for evaluation.
...
def preprocess_image(image_bytes, is_training=False, use_bfloat16=False,
  ...
  """
  if is_training:
    image_1 = preprocess_for_train(
                          image_bytes, use_bfloat16, image_size, None,
                                    randaug_num_layers, randaug_magnitude)
    image_2 = preprocess_for_trainaugment(
                              image_bytes, use_bfloat16, image_size, augment_name,
                                        randaug_num_layers, randaug_magnitude)
    # print("image: ", image_1.shape)
    image = tf.concat((image_1, image_2), axis=2)
    print("i^^^^^^^^^^^^^^mage.shape: ", image.shape)
    return image
